...
|---|---|---|
| Claude Code | `.claude/agents/` | Generated by [tools/gen-subagents.py](../tools/gen-subagents.py) |
| Kilo Code | `.kilo/agents/`, `.opencode/agents/` | Reads `.opencode/agents/` natively (shared with OpenCode) |
| OpenCode | `.opencode/agents/` | Generated by [tools/gen-subagents.py](../tools/gen-subagents.py) |
